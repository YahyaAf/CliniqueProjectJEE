...
public class PatientMapper {
    ...
    public static User toUserEntity(PatientRegisterRequestDTO dto, String hashedPassword) {
        User user = new User();
    ...
    public static Patient toPatientEntity(PatientRegisterRequestDTO dto, User user) {
