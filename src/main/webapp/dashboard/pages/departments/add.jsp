...
<head>
    ...
    <title>Add Department - MediCare+</title>
...
<main id="mainContent" class="p-8 ml-64">
    ...
    <!-- Page Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-white mb-2">Add New Department</h1>
        <p class="text-white/70">Create a new medical department</p>
    </div>
